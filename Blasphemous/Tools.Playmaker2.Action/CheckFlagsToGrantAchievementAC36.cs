...
public class CheckFlagsToGrantAchievementAC36 : FsmStateAction
{
	...
	private readonly List<string> itemsIds = new List<string> { "QI58", "RB05", "RB09", "QI11", "RB37", "RB02", "QI71", "RB12", "QI49" };

	public override void OnEnter()
	{
		bool flag = true;
		foreach (string itemsId in itemsIds)
		{
			string text = itemsId + achievementFlagSuffix.Value;
