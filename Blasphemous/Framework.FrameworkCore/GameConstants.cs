...
public static class GameConstants
{
	...
	public static Dictionary<string, float> LanguageLineSpacingFactor = new Dictionary<string, float> { { "ja", 1.2f } };

	public static Dictionary<string, float> LanguageLineSpacingTextPro = new Dictionary<string, float> { { "ja", 4f } };
	...
	public static readonly List<string> DistrictsWithoutName = new List<string> { "D13", "D14", "D18", "D19", "D21", "D22", "D25", "D24" };

	public static readonly List<string> FLAGS_ENDINGS_NEED_TO_BE_PERSISTENT = new List<string> { "_KILLED", "_OWNED", "_DISPLAYED", "_EXECUTED_FOR_AC27", "_BOSSDEAD_AC43" };

	public static readonly List<string> IGNORE_FLAG_TO_BE_PERSISTENT = new List<string> { "REDENTO_CAVE_ITEM_OWNED", "GEMINO_QI57_OWNED", "SOCORRO_STATE_KILLED" };
}
