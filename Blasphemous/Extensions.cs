...
public static class Extensions
{
	...
	{
		dir = dir.normalized;
		Vector3 vector = s.transform.TransformPoint(MyGetPointOnRectEdge(s.transform as RectTransform, Quaternion.Inverse(s.transform.rotation) * dir));
		...
		for (int i = 0; i < candidates.Count; i++)
		{
			...
			Vector3 rhs = selectable.transform.TransformPoint(position) - vector;
