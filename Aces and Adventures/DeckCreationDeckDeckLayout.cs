...
public class DeckCreationDeckDeckLayout : ADeckLayout<DeckCreationPile, AbilityDeck>
{
	...
	protected override CardLayoutElement _CreateView(AbilityDeck value)
	{
		return AbilityDeckView.GetCreationDeck(value);
	}
}
